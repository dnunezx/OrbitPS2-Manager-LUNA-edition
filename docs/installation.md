...
Build OrbitPS2 Manager - LUNA Edition locally with the commands in the project README. Public release downloads will be added when the fork has a release repository.
